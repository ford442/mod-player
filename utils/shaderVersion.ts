...
export const isCircularLayoutShader = (shaderFile: string): boolean => {
  ...
  return shaderFile.includes('pattern_bloom') || shaderFile.includes('v0.25') || shaderFile.includes('v0.26') || shaderFile.includes('v0.35') || shaderFile.includes('v0.37') || shaderFile.includes('v0.38') || shaderFile.includes('v0.42') || shaderFile.includes('v0.45') || shaderFile.includes('v0.46') || shaderFile.includes('v0.47') || shaderFile.includes('v0.48') || shaderFile.includes('v0.49') || shaderFile.includes('v0.50') || shaderFile.includes('v0.51') || shaderFile.includes('v0.52') || shaderFile.includes('v0.53') || shaderFile.includes('v0.54');
};
...
export const getBackgroundShaderFile = (shaderFile: string): string => {
  ...
  if (shaderFile.includes('pattern_bloom') || shaderFile.includes('v0.45') || shaderFile.includes('v0.46') || shaderFile.includes('v0.47') || shaderFile.includes('v0.48') || shaderFile.includes('v0.49') || shaderFile.includes('v0.50') || shaderFile.includes('v0.51') || shaderFile.includes('v0.52') || shaderFile.includes('v0.53') || shaderFile.includes('v0.54')) return 'bezel.wgsl';
  if (shaderFile.includes('v0.37') || shaderFile.includes('v0.38') || shaderFile.includes('v0.39')) return 'chassis_dark.wgsl';
...
export const shouldEnableAlphaBlending = (shaderFile: string): boolean => {
  return shaderFile.includes('pattern_bloom') || shaderFile.includes('v0.35') || shaderFile.includes('v0.38') || shaderFile.includes('v0.40') || shaderFile.includes('v0.42') || shaderFile.includes('v0.43') || shaderFile.includes('v0.44') || shaderFile.includes('v0.45') || shaderFile.includes('v0.46') || shaderFile.includes('v0.47') || shaderFile.includes('v0.48') || shaderFile.includes('v0.49') || shaderFile.includes('v0.50') || shaderFile.includes('v0.51') || shaderFile.includes('v0.52') || shaderFile.includes('v0.53') || shaderFile.includes('v0.54');
};
