// patternv0.56.wgsl
// Per-instrument color palette variant of v0.51.
// When paletteMode == 1u, the middle emitter uses a module-derived 1-D palette
// indexed by the unpacked instrument byte instead of pitch-hue.
// Pitch-hue behavior is byte-for-byte unchanged when paletteMode == 0u.
