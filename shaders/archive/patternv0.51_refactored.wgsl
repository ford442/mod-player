...
// This file is assembled from four logical modules. Each section is
// clearly marked so you can split it back out if you add a preprocessor
// later. To load programmatically, concatenate the four blocks in order
// and pass the resulting string to device.createShaderModule().
// ============================================================

// ╔════════════════════════════════════════════════════════════╗
// ║  SECTION 1 — common.wgsl                                   ║
// ║  Uniforms, bindings, structs, vertex shader, SDFs,         ║
// ║  palette helpers, and shared constants.                    ║
// ╚════════════════════════════════════════════════════════════╝
...
// ╔════════════════════════════════════════════════════════════╗
// ║  SECTION 2 — bloom_utils.wgsl                              ║
// ║  Bloom intensity curves, glow kernels, and dither.         ║
// ╚════════════════════════════════════════════════════════════╝
...
// ╔════════════════════════════════════════════════════════════╗
// ║  SECTION 3 — pattern_base.wgsl                             ║
// ║  Note duration unpacking, LED intensity logic,             ║
// ║  FragmentConstants, drawEmitterDiode, drawUnifiedLensCap.  ║
// ╚════════════════════════════════════════════════════════════╝
...
// ╔════════════════════════════════════════════════════════════╗
// ║  SECTION 4 — MAIN ENTRY POINT (v0.51-specific logic)       ║
