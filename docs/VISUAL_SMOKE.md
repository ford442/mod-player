...
1. Open `http://localhost:5173/?renderer=webgpu` (if the adapter/device probe fails, the app auto-falls-back to WebGL2 — see `window.__WEBGPU_PROBE__` for probe details)
