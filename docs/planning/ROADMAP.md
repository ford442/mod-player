...
| P1 | [#414](https://github.com/ford442/mod-player/issues/414) | Finish analysis-bus consumers; split `MainLayout.tsx` (848 lines) into chrome vs `stageMode` performance stage. Leftover of closed #404. |
