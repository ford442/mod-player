// patternv0.44.wgsl
// Frosted Wall 64 (Square) - Enhanced Dual-Color Lighting Edition
...
fn fs(in: VertexOut) -> @location(0) vec4<f32> {
 ...
 // Check playhead distance (wider range for diffusion)
