// patternv0.45.wgsl
// Frosted Bloom - Enhanced Dual-Color Lighting Edition
// - Instanced rings (like v0.35)
// - Frosted cap material with Blue idle / Orange active lighting
...
fn fs(in: VertexOut) -> @location(0) vec4<f32> {
 ...
 hasNote = (noteChar >= 65u && noteChar <= 122u); // Simple check
 ...
 let playheadActivation = 1.0 - smoothstep(0.0, 2.0, rowDist); // Wider range
 isOnPlayhead = playheadActivation > 0.3;
 ...
 return vec4<f32>(finalColor * dimFactor, edge);
}
