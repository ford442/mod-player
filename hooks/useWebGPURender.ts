...
export function useWebGPURender(
  ...
  const render = useCallback(() => {
    ...
    if (uniformBufferRef.current) {
      ...
      if (shaderFile.includes('v0.21') || shaderFile.includes('v0.40') || shaderFile.includes('v0.43') || shaderFile.includes('v0.44') || shaderFile.includes('v0.45') || shaderFile.includes('v0.46') || shaderFile.includes('v0.47') || shaderFile.includes('v0.48') || shaderFile.includes('v0.49') || shaderFile.includes('v0.50') || shaderFile.includes('v0.51') || shaderFile.includes('v0.52') || shaderFile.includes('v0.53') || shaderFile.includes('v0.54')) {
      ...
      const uniformByteLength = fillUniformPayload(layoutTypeRef.current, {
        numRows, numChannels,
        playheadRow: tickRow,
        playheadRowAsFloat: shaderFile.includes('v0.21') || shaderFile.includes('v0.30') || shaderFile.includes('v0.35') || shaderFile.includes('v0.38') || shaderFile.includes('v0.39') || shaderFile.includes('v0.40') || shaderFile.includes('v0.42') || shaderFile.includes('v0.43') || shaderFile.includes('v0.44') || shaderFile.includes('v0.45') || shaderFile.includes('v0.46') || shaderFile.includes('v0.47') || shaderFile.includes('v0.48') || shaderFile.includes('v0.49') || shaderFile.includes('v0.50') || shaderFile.includes('v0.51') || shaderFile.includes('v0.52') || shaderFile.includes('v0.53') || shaderFile.includes('v0.54'),
